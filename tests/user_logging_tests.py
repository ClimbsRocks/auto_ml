...
# def test_verify_features_correctly_handles_categorical_features():


# def test_verify_features_handles_date_features():


# def test_verify_features_finds_missing_training_features():


def test_verify_features_find_missing_prediction_features():
        np.random.seed(0)
