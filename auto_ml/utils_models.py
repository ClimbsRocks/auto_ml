...
def get_search_params(model_name):
    grid_search_params = {
        ...
        , 'LGBMClassifier': {
            ...
            , 'num_leaves': [2, 3, 4, 5, 6, 7, 8, 9, 10, 15, 20, 25, 30, 35, 40, 50, 65, 80, 100, 125, 150, 200, 250, 300, 400, 500]
            , 'min_data_in_leaf': [5, 10, 20, 35, 50, 75, 100, 125, 150, 200, 250, 300, 400, 500, 750, 1000, 2000, 3000, 5000, 10000]
            , 'subsample': [0.7, 0.8, 0.85, 0.9, 0.95, 1.0]
            , 'subsample_freq': [1, 2, 5, 10, 25, 50]
